...
func (r *OrderRepository) ListByInvoiceID(ctx context.Context, invoiceID int64) ([]*domain.Order, error) {
	query := fmt.Sprintf(`SELECT %s FROM client_orders WHERE invoice_id = $1`, orderCols)
...
func (r *OrderRepository) Create(ctx context.Context, o *domain.Order) error {
	...
	if o.ProductID > 0 {
		var exists bool
		_ = r.pool.QueryRow(ctx, `SELECT EXISTS(SELECT 1 FROM products WHERE id = $1)`, o.ProductID).Scan(&exists)
		if exists {
			prodID = &o.ProductID
		}
	}

	return r.pool.QueryRow(ctx, query, o.ClientID, prodID, o.InvoiceID, o.Status, o.Title, o.Period, o.Price, o.Currency, o.Config, o.ActivatedAt, o.ExpiresAt, o.NextDueDate, o.SuspendedAt, o.SuspensionReason).Scan(&o.ID, &o.CreatedAt, &o.UpdatedAt)
}
