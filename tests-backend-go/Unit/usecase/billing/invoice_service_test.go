...
func TestInvoiceService_PayWithBalance(t *testing.T) {
	...
	invoice, _ := service.CreateInvoice(ctx, billing.CreateInvoiceDTO{
		ClientID: client.ID,
		Currency: "USD",
		Items: []billing.CreateInvoiceItemDTO{
